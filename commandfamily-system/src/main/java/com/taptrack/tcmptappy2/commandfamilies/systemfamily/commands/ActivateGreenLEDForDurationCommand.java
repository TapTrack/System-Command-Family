...
public class ActivateGreenLEDForDurationCommand extends AbstractSystemMessage {
    public static final byte COMMAND_CODE = (byte)0x0F;
    private int duration;

    public ActivateGreenLEDForDurationCommand() {
        this.duration = 0;
    }

    public ActivateGreenLEDForDurationCommand(int duration) {
